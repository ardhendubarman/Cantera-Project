...
Tin = 1113.0  # unburned gas temperature [K]
...
f.save('CH4_1113.xml', 'no_energy', 'solution with the energy equation disabled')
...
f.save('CH4_1113.xml', 'energy', 'solution with mixture-averaged transport')
#f.show_solution()
...
f.write_csv('CH4_1113.csv', quiet=True)

#%%
z=f.grid
pkl.dump(z,open('data_1113.pkl','wb'))
i=len(z)
