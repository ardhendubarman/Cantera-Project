...
f.save('CH4_1083.xml', 'no_energy', 'solution with the energy equation disabled')
...
f.save('CH4_1083.xml', 'energy', 'solution with mixture-averaged transport')
#f.show_solution()
...
f.write_csv('CH4_1083.csv', quiet=True)

#%%
z=f.grid
pkl.dump(z,open('data_1083.pkl','wb'))
i=len(z)
