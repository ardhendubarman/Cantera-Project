...
Tin = 1143.0  # unburned gas temperature [K]
...
f.save('CH4_1143.xml', 'no_energy', 'solution with the energy equation disabled')
...
f.save('CH4_1143.xml', 'energy', 'solution with mixture-averaged transport')
#f.show_solution()
...
f.write_csv('CH4_1143.csv', quiet=True)

#%%
z=f.grid
pkl.dump(z,open('data_1143.pkl','wb'))
i=len(z)
