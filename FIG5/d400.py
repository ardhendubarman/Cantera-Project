...
Tin = 400.0  # unburned gas temperature [K]
...
f.save('CH4_400.xml', 'no_energy', 'solution with the energy equation disabled')
...
f.save('CH4_400.xml', 'energy', 'solution with mixture-averaged transport')
#f.show_solution()
...
f.write_csv('CH4_400.csv', quiet=True)

#%%
z=f.grid
pkl.dump(z,open('data_400.pkl','wb'))
i=len(z)
