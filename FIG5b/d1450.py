...
initial_grid = np.linspace(0.0, 0.03, 6)  # m
...
f.save('CH4_1450.xml', 'no_energy', 'solution with the energy equation disabled')
...
f.save('CH4_1450.xml', 'energy', 'solution with mixture-averaged transport')
#f.show_solution()
...
f.write_csv('CH4_1450.csv', quiet=True)

#%%
z=f.grid/f.u[0]
pkl.dump(z,open('data_1450.pkl','wb'))
i=len(z)
